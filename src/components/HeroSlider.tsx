...
const slides = {
  ...
  en: [
    {
      id: 1,
      title: 'Accountant in Tunis for entrepreneurs, freelancers and companies',
      description: 'Accounting firm in Tunis specialized in business creation, accounting management and tax optimization for business leaders.',
      image: 'https://images.unsplash.com/photo-1554200876-56c2f25224fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    ...
    {
      id: 2,
      title: 'Investor or entrepreneur?',
      description: 'Want to start, take over a business or launch a startup in Tunisia? Benefit from comprehensive accounting, tax and legal support.',
      image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    ...
    {
      id: 3,
      title: 'Formalities & procedures',
      description: 'Our firm supports you through all business creation formalities in Tunisia: fast registration, commercial registry, domiciliation, professional bank account opening and tax compliance. Simplify your procedures and launch your activity with peace of mind.',
      image: 'https://images.unsplash.com/photo-1450101499163-c8848c66cb85?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
      button: 'See formalities',
      href: '/formalites',
    },
  ],
}
...
export function HeroSlider({ lang, dict }: { lang: string; dict: any }) {
  const isFr = lang === 'fr'
  const currentSlides = slides[isFr ? 'fr' : 'en']
      ...
      <div className="absolute bottom-8 left-0 right-0 z-20 flex justify-center gap-4">
        {currentSlides.map((_, index) => (
          <button
            ...
            aria-label={`${isFr ? 'Aller au slide' : 'Go to slide'} ${index + 1}`}
          >
            <span
              className={cn(
