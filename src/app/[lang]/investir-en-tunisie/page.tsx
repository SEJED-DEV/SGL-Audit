...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://sglaudit.com/${lang}/investir-en-tunisie`,
    },
...
export default async function InvestirEnTunisiePage({
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: isFr ? 'Investir en Tunisie' : 'Invest in Tunisia', item: `https://sglaudit.com/${lang}/investir-en-tunisie` },
    ],
  }
